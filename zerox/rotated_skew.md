...
To record a sequence, simply press RECORD and PLAY, then play your MIDI keyboard in time to the Sequencer's disk track. When the sequence loops back around to bar 1, you'll hear what you played—only all timing errors will be corrected! (Timing correction may be adjusted or defeated.) Any additional notes played will be added to the track—existing notes are not erased while recording! 
FAST FORWARD, REWIND, and LOCATE controls may be used at any time to quickly access any location in your sequencer for spot-recording. To overdub a new part, select a different track and start recording—while you record, the first track will play in perfect sync (unless you mute it, or SOLO another track). In this way, up to 32 tracks may be overdubbed! All MIDI effects are recorded including pitch bend, modulation, velocity, aftertouch, sustain pedal, and program changes!
...
* TEMPO may be specified in BEATS-PER-MINUTE or FRAMES-PER-BEAT at 24, 25, or 30 frames per second, even (more importantly) frame!
...
(818) 708-8131 TEL: #298949 LINN UR